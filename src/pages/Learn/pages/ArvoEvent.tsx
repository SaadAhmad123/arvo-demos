        ...
        <div className={Md3ContentPadding}>
          ...
          <ReMark
            content={cleanString(`
              ...
              | \`subject\`           | [CloudEvents Core](https://github.com/cloudevents/spec/blob/main/cloudevents/spec.md#subject)            | Workflow process identifier that uniquely links related events throughout their distributed execution lifecycle. Acts as the primary correlation key for maintaining stateful context across service boundaries, enabling event handlers to retrieve and persist workflow state consistently. See, the [technical documentation](https://saadahmad123.github.io/arvo-core/documents/ArvoEvent.html) to learn more about it. |
